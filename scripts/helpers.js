(function(window, $){
  ...
  window.AppUtil = {
    ...
    chipSuggestions: [
      { name: 'Jollof rice', category: 'dinner' },
      { name: 'Egusi soup', category: 'dinner' },
      { name: 'Pounded yam', category: 'dinner' },
      { name: 'Suya', category: 'dinner' },
      { name: 'Fried plantain (Dodo)', category: 'any' },
      { name: 'Moi moi', category: 'lunch' },
      { name: 'Akamu (pap)', category: 'breakfast' },
      { name: 'Yam & egg', category: 'breakfast' },
      { name: 'Ewa Aganyin (spicy beans)', category: 'lunch' },
      { name: 'Pepper soup', category: 'dinner' },
      { name: 'Banga soup', category: 'dinner' },
      { name: 'Nkwobi', category: 'dinner' },
      { name: 'Ofada rice', category: 'lunch' },
      { name: 'Puff-puff', category: 'dessert' },
      { name: 'Chin-chin', category: 'dessert' },
      { name: 'Okra soup', category: 'dinner' },
      { name: 'Ogbono soup', category: 'dinner' },
      { name: 'Efo riro', category: 'dinner' },
      { name: 'Isi ewu', category: 'dinner' },
      { name: 'Ewa riro', category: 'lunch' },
      { name: 'Asaro (yam porridge)', category: 'dinner' },
      { name: 'Ofada stew', category: 'dinner' },
      { name: 'Fried fish', category: 'dinner' },
      { name: 'Afang soup', category: 'dinner' },
      { name: 'Oha soup', category: 'dinner' }
    ],
